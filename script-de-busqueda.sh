...
cat sol-2003-2018.csv  | grep -E "Abejas.*organización|organización.*Abejas" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "Abejas.*indígenas|indígenas.*Abejas" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "Zedillo.*Chiapas|Chiapas.*Zedillo" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E " Zedillo.*indígenas|indígenas.*Zedillo" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E " Zedillo.*matanza|matanza.*Zedillo" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E " Zedillo.masacre|masacre.Zedillo" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E " zedillo.masacre|masacre.zedillo" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "sobrevivientes.*Acteal|Acteal.*sobrevivientes" >> solicitudes-ddhh-independiente.csv 
...
cat sol-2003-2018.csv  | grep -E "Fiscalía Especializada de Justicia Indígena.*Acteal|Acteal.*Fiscalía Especializada de Justicia Indígena" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "Fiscalía Especializada de Justicia Indígena.*Chiapas|Chenalhó.*Fiscalía Especializada de Justicia Indígena" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "Fiscalía Especializada de Justicia Indígena.*Chenalhó|Chenalhó.*Fiscalía Especializada de Justicia Indígena" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "Pantelhó.*Chiapas|Chiapas.*Pantelhó" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "contrainsurgente.*Chenalhó|Chenalhó.*contrainsurgente" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "violencia.*Acteal|Acteal.*violencia" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "tsotsil.*ataque|ataque.*tsotsiles" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "tzotsil.*ataque|ataque.*tzotsiles" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "tsotsil.*masacre|masacre.*tsotsiles" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "tzotsil.*masacre|masacre.*tzotsiles" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "tsotsil.*matanza|matanza.*tsotsil" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "tzotzil.*matanza|matanza.*tzotziles" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "obernador.*Ruiz Ferró|Ruiz Ferró.*obernador" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "obernador.*Julio César Ruiz|Julio César Ruiz.*obernador" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "obernación.*Chauyffet|Chauyffet.*obernación" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "Presidente.*Jacinto Arias Cruz|Jacinto Arias Cruz.*Presidente" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "presidente.*Jacinto Arias Cruz|Jacinto Arias Cruz.*presidente" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "Presidente.*Arias|Arias.*Presidente" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "presidente.*Arias|Arias.*presidente" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "San Miguel Ocosingo" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Ocosingo" >> solicitudes-ddhh-independiente.csv
cat sol-2003-2018.csv  | grep -E "San Cristóbal.*ataque|ataque.*San Cristóbal" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "san cristóbal.*ataque|ataque.*san cristobal" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "San Cristóbal.*matanza|matanza.*San Cristóbal" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "San Cristóbal.*masacre|masacre.*San Cristóbal" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Aguas Blancas" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "aguas blancas" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Coyuca de Benítez" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "coyuca de benítez" >> solicitudes-ddhh-independiente.csv 
...
cat sol-2003-2018.csv  | grep -i "Apatzin" | grep -i "matanza" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Apatzin" | grep -i "federales" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Apatzin" | grep -i "masacre" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Apatzin" | grep -i "masacre" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "emboscada.*campesinos|campesinos.*emboscada" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "emboscada.*policía|policía.*emboscada" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "emboscada.*federales|federales.*emboscada" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "emboscada.*policía federal|policía federal.*emboscada" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "Policía Federal.*masacre|masacre.*Policía Federal" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "Policía Federal.*matanza|matanza.*Policía Federal" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "Autodefensas.*Michoacán|Michoacán.*Autodefensas" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "autodefensas.*Michoacán|Michoacán.*autodefensas" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "autodefensas" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "michoacán" | grep -i "viagras" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Michoacán" | grep -i "viagras" >> solicitudes-ddhh-independiente.csv 
...
cat sol-2003-2018.csv  | grep -E "ejidatarios.*Estado de México|Estado de México.*ejidatarios" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "ejidatarios" >> solicitudes-ddhh-independiente.csv
cat sol-2003-2018.csv  | grep -i "Ayotzinapa 2011" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Escuela Normal Rural de Ayotzinapa" >> solicitudes-ddhh-independiente.csv 
...
cat sol-2003-2018.csv  | grep -i "Ángel Aguirre Rivero" >> solicitudes-ddhh-independiente.csv 
#cat sol-2003-2018.csv  | grep -E "estudiantes.*campesinos|campesinos.*estudiantes" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "Costa Chica.*Guerrero|Guerrero.*Costa Chica" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "35 pesos " >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Federación de Estudiantes Campesinos Socialistas" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Sindicato Nacional de Trabajadores de la Educación" >> solicitudes-ddhh-independiente.csv 
...
cat sol-2003-2018.csv  | grep -E "indígenas.*Tecoanapa|Tecoanapa.*indígenas" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Xanii Tsavvi" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Eric Escobar.*Guerrero|Guerrero.*Eric Escobar" >> solicitudes-ddhh-independiente.csv 
#cat sol-2003-2018.csv  | grep -i "federales.*estudiantes|estudiantes.*federales" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Ayotzinapa 2014" >> solicitudes-ddhh-independiente.csv 
...
cat sol-2003-2018.csv  | grep -i "Tixtla de Guerrero" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Raúl Isidro Burgos" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Cocula" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "iguala" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E -i "Guerreros Unidos.*estudiantes" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E -i "José Luis Abarca" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Ejército Revolucionario del Pueblo Insurgente" >> solicitudes-ddhh-independiente.csv 
...
cat sol-2003-2018.csv  | grep -i "Abarca" >> solicitudes-ddhh-independiente.csv 
...
cat sol-2003-2018.csv  | grep -i "equipo argentino" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "forenses argentinos" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Cadereyta" >> solicitudes-ddhh-independiente.csv 
...
cat sol-2003-2018.csv  | grep -E "Juárez.*desaparición|desaparición.*Juárez" | grep -i "mujer" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "juárez.*desaparición|desaparición.*juárez" | grep -i "mujer" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "juarez.*desaparición|desaparición.*juarez" | grep -i "mujer" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "desaparición forzada" >> solicitudes-ddhh-independiente.csv 
##
cat sol-2003-2018.csv  | grep -i "desaparición" | grep -i "forzada" >> solicitudes-ddhh-independiente.csv 
...
cat sol-2003-2018.csv  | grep -E "Juárez|juárez" | grep -i "género" >> solicitudes-ddhh-independiente.csv 
...
cat sol-2003-2018.csv  | grep -i "ABC" >> solicitudes-ddhh-independiente.csv 
...
cat sol-2003-2018.csv  | grep -i "SAN FERNANDO" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -E "San Fernando.*2010|2010.*San Fernando" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i  "migrantes" | grep "72" >> solicitudes-ddhh-independiente.csv 
...
cat sol-2003-2018.csv  | grep -E "zetas.*San Fernando|San Fernando.*zetas" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "zetas" >> solicitudes-ddhh-independiente.csv 
...
cat sol-2003-2018.csv  | grep -i "cadáveres migrantes" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "cuerpos migrantes" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "SAN FERNANDO 2011" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "San Fernando" | grep -i "2011" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "segundo asesinato San Fernando" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "segunda masacre San Fernando" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "zetas Tamaulipas" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "zetas" | grep -i "procuraduría de justicia" | grep -i "tamaulipas" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "secuestros omnibus de México " >> solicitudes-ddhh-independiente.csv 
...
cat sol-2003-2018.csv  | grep -i "pasajeros" | grep "frontera" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Zetas" | grep -i  "frontera" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "fosas comunes" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "fosas" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "fosas" | grep -ir  "migrantes" >> solicitudes-ddhh-independiente.csv 
...
cat sol-2003-2018.csv  | grep -i "ejido La Joya" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "ejido" | grep -i  "La Joya" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Joel Reséndiz Moreno " >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "asesinato 193 personas" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "masacre 6 de abril de 2011" >> solicitudes-ddhh-independiente.csv 
...
cat sol-2003-2018.csv  | grep -i "movimiento político" >> solicitudes-ddhh-independiente.csv 
...
cat sol-2003-2018.csv  | grep -i "Guerra 1960-1970" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Partido Comunista Mexicano" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "confrontación Estado" >> solicitudes-ddhh-independiente.csv 
...
cat sol-2003-2018.csv  | grep -i "Mexcaltepec" >> solicitudes-ddhh-independiente.csv 
...
cat sol-2003-2018.csv  | grep -i "Guerra Sucia" | grep -ir "Luis Echeverría" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "muertos de tlatelolco" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "tlatelolco"| grep -i "estudiante" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "movimiento" | grep -i  "estudiantes" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "estudiantes 1968" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "matanza de la Plaza de las Tres Culturas" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "masacre Tlatelolco" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Plaza de las Tres Culturas 68" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Batallón Olimpia" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "DFS" >> solicitudes-ddhh-independiente.csv 
...
cat sol-2003-2018.csv  | grep -i "Revolución cultural del 1968" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "movimiento del 68" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "movimiento estudiantil 68" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "manifestación 1968" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "manifestacion 1968" >> solicitudes-ddhh-independiente.csv
...
cat sol-2003-2018.csv  | grep -i "Tlatlaya" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Eruviel" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Eruviel Ávila" | grep -i "Tlatlaya" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Eruviel Avila" | grep -i "Tlatlaya" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Eruviel Ávila" grep -i "San Pedro Limón" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Eruviel Avila" grep -i "San Pedro Limón" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Eruviel Avila" grep -i "San Pedro Limon" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "San Pedro Limón" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "San Pedro Limon" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Cuadrilla Nueva" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Eruviel Ávila" grep -i "ejército" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Eruviel Avila" grep -i "ejército" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Eruviel Avila" grep -i "ejercito" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "delincuencia organizada" grep -i "Estado de México" grep -i "Guerrero" >> solicitudes-ddhh-independiente.csv 
...
cat sol-2003-2018.csv  | grep -i "Mario Patrón Sánchez" grep -i "Centro Pro" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Mario Patrón" grep -i  "Centro Pro" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Relatoría Especial sobre las Ejecuciones Extrajudiciales Sumarias" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Ejecuciones" | grep -i "arbitrarias" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "abatir" | grep -i "ejército" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Cienfuegos" | grep "Tlatlaya" >> solicitudes-ddhh-independiente.csv 
#Triple queries
cat sol-2003-2018.csv  | grep -i "disturbios" | grep -i "Texcoco" | grep -i "Lechería" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Texcoco" | grep -i "Lechería" | grep -i "disturbios" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Texcoco" | grep -i "Lecheria" | grep -i "disturbios" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Texcoco" | grep -i "Lecheria" | grep -i "ataque" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Texcoco" | grep -i "Lecheria" | grep -i "ejército" >> solicitudes-ddhh-independiente.csv 
cat sol-2003-2018.csv  | grep -i "Texcoco" | grep -i "Lecheria" | grep -i "ejercito" >> solicitudes-ddhh-independiente.csv 
